...
switch-to-poetry: ## Switch to poetry package manager.
	...
	@rm -rf .venv
	@poetry init --no-interaction --name=botpporojones --author=Sapporo Jones
	@echo "" >> pyproject.toml
	@echo "[tool.poetry.scripts]" >> pyproject.toml
	@echo "botpporojones = 'botpporojones.__main__:main'" >> pyproject.toml
	...
	@echo "Please run 'poetry shell' or 'poetry run botpporojones'"
